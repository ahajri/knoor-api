...
import com.knoor.soft.knoorapi.enums.ErrorMessageEnum;


@Component(BeanIds.AUTHENTICATION_MANAGER)
public class KNAuthenticationManager implements AuthenticationManager {

    @Autowired
    private KNUserDetailsService sigsUserDetailsService;
