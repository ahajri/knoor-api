...
import com.knoor.soft.knoorapi.constants.KeyConstants;
import com.knoor.soft.knoorapi.constants.TimeConstants;
import com.knoor.soft.knoorapi.constants.UrlConstants;
import com.knoor.soft.knoorapi.exception.BusinessException;
import com.knoor.soft.knoorapi.utils.HttpUtils;
...
public class PrayTimeService {
	...
	public Map<String, Object> getPrayTimeByLatLngDate(final double lat, final double lng, final Date date, final String timeZone)
		...
		try {
			...
			String nightLength = KNDateUtils.getDurationString(nightLengthSecond);
			c.clear();
			c.setTime(sunsetDate);
